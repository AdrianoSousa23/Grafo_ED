...
public class Main {
    ...
    private static void totalCorredores(int n) {
        ...
        TrechoPista trechoC = new TrechoPista("C", 15); // trecho da pista B será de 15 km

//      Adicionando esses trechos no grafo
        grafo.adicionarTrecho(trechoA);
        grafo.adicionarTrecho(trechoB);
        grafo.adicionarTrecho(trechoC);
        ...
        for (int i = 0; i < n; i++) {
            ...
            grafo.adicionarCorredor(corredores.get(i), trechoC, numeroAleatorio()); // Associe o novo trecho a um tempo aleatório
            ...
            int tempoTrechoC = numeroAleatorio(); // Tempo aleatório para o trecho c

            int tempoTotal = tempoTrechoA + tempoTrechoB + tempoTrechoC;
